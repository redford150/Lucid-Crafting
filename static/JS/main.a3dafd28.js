const App = {
  ...
  async init() {
    ...
    this.root.innerHTML = '<div class="app-shell"><div class="top-panel"><h1>Lucid Crafting Sheet</h1><div class="subtitle">made by Charlie Brown - UID 474</div><div id="app-controls"></div></div><div id="recipe-list"></div></div>';
